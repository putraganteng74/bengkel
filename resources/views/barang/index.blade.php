                        ...
                        <table class="table align-items-center mb-0">
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-uppercase text-secondary text-xxs font-weight-bolder">Nama Barang</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-xs font-weight-bold">
                                        @if ($item->foto)
                                            <img src="{{ asset('storage/' . $item->foto) }}" alt="{{ $item->nama }}" width="80" class="rounded">
                                        @else
                                            <span class="text-muted">Tidak ada foto</span>
                                        @endif
                                    </td>
                                    <td class="text-xs font-weight-bold">{{ $item->nama }}</td>
                                    <td class="text-xs font-weight-bold">Rp {{ number_format($item->harga, 0, ',', '.') }}</td>
