        ...
        <div class="col-12">
            <div class="card mb-4">
                <div class="card-header pb-0">
                    <h6>Laporan Barang Bulanan ({{ \Carbon\Carbon::create()->month($month)->translatedFormat('F') }}
                        {{ $year }})</h6>
                </div>
            ...
            <div class="card mb-4">
                <div class="card-header pb-0">
                    <h6>Laporan Harian Layanan ({{ \Carbon\Carbon::create()->month($month)->translatedFormat('F') }}
                        {{ $year }})</h6>
                </div>
                <div class="card-body px-0 pt-0 pb-2">
                    <div class="table-responsive p-0">
